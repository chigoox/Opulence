...
export const AdminProduct = () => {
    return (
        <div>
            <Button className='h-6 mb-10  w-fit p-2 bg-white rounded min-w-0'><AiFillPlusSquare color='blue' size={24} /></Button>
            <div className='grid gap-4 border-b grid-cols-3 text-gray-600'>
